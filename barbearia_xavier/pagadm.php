    ...
    <nav class="navbar navbar-inverse">
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li><a href="pagusuario.php" style="color:honeydew;"><span class="glyphicon glyphicon-user"></span> Gerenciamento de Contas (<?php echo $nome; ?>)</a></li>
        ...
        <?php
            ...
            while($exibe = mysqli_fetch_assoc($resultSet)){
                echo "<tr>
                        ...
                        <th><a href='modusu.php?id=".$exibe['idUsuario']."'><img src='imagens/two.png' width='30px' length='30px'></a></th>
                    </tr>";
            }
        ?>
        </table>
